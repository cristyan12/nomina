...
class UserControllerTest extends TestCase
{
     ...
     * @test 
     */
    function a_user_cannot_see_the_form_to_edit_users()
    {
     ...
     * @test 
     */
    function a_user_cannot_see_the_the_page_of_details_of_user()
    {
        $user = factory('App\User')->create();
     ...
     * @test 
     */
    function a_user_cannot_update_a_user()
    {
        $user = factory('App\User')->create();
     ...
     * @test 
     */
    function a_user_cannot_delete_a_user()
    {
        $user = factory('App\User')->create();
