...
Route::middleware(['auth'])->group(function() {
    ...
    Route::view('/archivos', 'registry')
        ->name('records')
        ->middleware('permission:registry');
    ...
    // Load Familiar
    Route::get('employees/{employee}/load-familiars', 'LoadFamiliarController@index')
        ->name('familiars.index')
        ->middleware('permission:familiars.index');

    Route::get('employees/{employee}/load-familiar', 'LoadFamiliarController@create')
        ->name('familiars.create')
        ->middleware('permission:familiars.create');

    Route::post('familiars/store', 'LoadFamiliarController@store')
        ->name('familiars.store')
        ->middleware('permission:familiars.create');
    ...
    Route::post('concepts/store', 'ConceptController@store')
        ->name('concepts.store')
        ->middleware('permission:concepts.create');
    ...
    Route::namespace('Company')->group(function () {
        ...
        Route::get('companies/{company}/edit', 'UpdateCompanyController@edit')
            ->name('companies.edit')
            ->middleware('permission:companies.edit');

        Route::put('companies/{company}', 'UpdateCompanyController@update')
            ->name('companies.update')
            ->middleware('permission:companies.edit');

        Route::get('companies/{company}', 'ShowCompanyController@show')
            ->name('companies.show')
